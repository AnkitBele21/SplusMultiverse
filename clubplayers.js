...
// Event listener for the Adjustment button
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (adjustmentButton) {
        adjustmentButton.addEventListener("click", function () {
            ...
            populateWinnerAndLoserOptions();
        });
    }

    // Add event listener to the close button of the modal to hide the modal
    const closeModalButton = document.querySelector("#adjustmentModal .close");
    if (closeModalButton) {
    ...
    // Add event listener to the form submit event to handle adjustment submission
    ...
    if (adjustmentForm) {
        adjustmentForm.addEventListener("submit", function (e) {
            ...
            handleAdjustmentSubmission(winnerName, loserName, adjustmentAmount);
        });
    }
});

function populateWinnerAndLoserOptions() {
    const winnerSelect = document.getElementById("winnerName");
    const loserSelect = document.getElementById("loserName");

    // Clear existing options
    winnerSelect.innerHTML = "";
    loserSelect.innerHTML = "";

    // Populate options from player list
...
function handleAdjustmentSubmission(winnerName, loserName, adjustmentAmount) {
    // Implement logic to handle adjustment submission
    console.log("Winner:", winnerName);
    console.log("Loser:", loserName);
    console.log("Adjustment Amount:", adjustmentAmount);

    // After handling submission, hide the modal
    const modal = document.getElementById("adjustmentModal");
    modal.style.display = "none";
